              ...
              <div style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  <button type="submit" disabled={status === 'loading'} style={{
                    ...
                    borderRadius: 8, background: status === 'loading' ? '#ccc' : 'linear-gradient(135deg, var(--color-primary-dark, #2c6262) 0%, var(--color-primary, #2a9b96) 100%)', border: 'none',
                    ...
                    onMouseLeave={(e) => { if (status !== 'loading') { e.currentTarget.style.background = 'linear-gradient(135deg, var(--color-primary-dark, #2c6262) 0%, var(--color-primary, #2a9b96) 100%)'; e.currentTarget.style.color = '#fff' } }}
                  >
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <button type="submit" disabled={status === 'loading'} style={{
                  ...
                  background: status === 'loading' ? '#ccc' : 'linear-gradient(135deg, var(--color-primary-dark, #2c6262) 0%, var(--color-primary, #2a9b96) 100%)', border: 'none',
                  fontSize: 15, fontWeight: 700, fontFamily: "var(--font-space-grotesk), 'Space Grotesk', sans-serif",
                  color: '#fff', cursor: status === 'loading' ? 'not-allowed' : 'pointer', transition: 'background 0.18s ease, color 0.18s ease', marginTop: 4,
                }}
                  onMouseEnter={(e) => { if (status !== 'loading') { e.currentTarget.style.background = 'var(--color-primary-light, #50b5a2)'; e.currentTarget.style.color = '#000' } }}
                  onMouseLeave={(e) => { if (status !== 'loading') { e.currentTarget.style.background = 'linear-gradient(135deg, var(--color-primary-dark, #2c6262) 0%, var(--color-primary, #2a9b96) 100%)'; e.currentTarget.style.color = '#fff' } }}
                >
