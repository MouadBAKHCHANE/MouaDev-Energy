    ...
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      <div style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ width: 'clamp(200px, 40%, 420px)', height: 'clamp(40px, 6vw, 72px)', borderRadius: 12, background: 'rgba(255,255,255,0.1)' }} />
        </div>
      </div>
          ...
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} style={{ borderRadius: 20, overflow: 'hidden', border: '1px solid #e8e8e8' }}>
              ...
              <div style={{ padding: '20px 24px 24px' }}>
                <div style={{ width: 80, height: 22, borderRadius: 20, background: '#eef3f2', marginBottom: 12 }} />
                <div style={{ width: '85%', height: 18, borderRadius: 5, background: '#f0f0f0', marginBottom: 8 }} />
                <div style={{ width: '65%', height: 18, borderRadius: 5, background: '#f0f0f0', marginBottom: 16 }} />
                <div style={{ width: '100%', height: 13, borderRadius: 4, background: '#f5f5f5', marginBottom: 8 }} />
                <div style={{ width: '80%', height: 13, borderRadius: 4, background: '#f5f5f5' }} />
              </div>
            </div>
          ))}
        </div>
