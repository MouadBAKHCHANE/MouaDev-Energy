  ...
  return (
    <main>
      <PageHero
        ...
        title={blog.title}
        bgImage={blog.coverImage ? urlFor(blog.coverImage).width(1600).url() : blog.coverImg}
        compact={true}
      />
      ...
      <section style={{ background: '#fff', padding: '100px 20px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <motion.img
            ...
            src={blog.coverImage ? urlFor(blog.coverImage).width(900).url() : blog.coverImg}
            alt={blog.title}
            style={{
              width: '100%',
              height: 420,
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          <div className="related-grid">
            {relatedBlogs.map((related, i) => (
              ...
              >
                <img
                  src={related.coverImage ? urlFor(related.coverImage).width(500).url() : related.coverImg}
                  alt={related.title}
                  style={{
                    width: '100%',
                    height: 220,
