...
export const services: Service[] = [
  {
    ...
    steps: [
      { title: 'Prise de rendez-vous', desc: 'Planifiez votre entretien en ligne ou par téléphone selon vos disponibilités.' },
      { title: 'Inspection visuelle', desc: 'Nos techniciens inspectent les panneaux, le câblage et les fixations.' },
      { title: 'Tests électriques', desc: 'Mesure de la tension, du courant et comparaison avec les valeurs attendues.' },
      { title: 'Nettoyage', desc: 'Les panneaux sont nettoyés avec un système à eau pure et des brosses adaptées.' },
      { title: 'Rapport', desc: 'Vous recevez un rapport complet avec les données de performance et les recommandations.' },
      { title: 'Suivi', desc: 'Les éventuelles réparations sont planifiées et réalisées rapidement.' },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: 'Prise de rendez-vous', desc: 'Contactez-nous pour fixer une date d\'intervention à votre convenance.' },
      { title: 'Diagnostic', desc: 'Nos techniciens réalisent un diagnostic complet de votre installation.' },
      { title: 'Nettoyage', desc: 'Filtres, échangeurs et composants sont nettoyés en profondeur.' },
      { title: 'Contrôle', desc: 'Les performances et les pressions sont mesurées et comparées aux normes.' },
      { title: 'Optimisation', desc: 'Les réglages sont ajustés pour un fonctionnement optimal.' },
      { title: 'Rapport', desc: 'Un compte-rendu détaillé vous est remis avec l\'état de l\'installation.' },
    ],
    heroImg: '/Photos HD/Visuels Technique/Technique - PAC/Heat pump AdobeStock.webp',
    icon: '/icons/CHARTEGRAPHIQUENAOSERVICE-20.webp',
  },
  {
    slug: 'boiler-thermodynamique',
    ...
    steps: [
      { title: 'Prise de rendez-vous', desc: 'Planifiez votre entretien selon vos disponibilités.' },
      { title: 'Inspection', desc: 'Vérification visuelle et technique de l\'ensemble du boiler.' },
      { title: 'Détartrage', desc: 'Nettoyage en profondeur du ballon et de la résistance.' },
      { title: 'Contrôle sanitaire', desc: 'Vérification des températures pour garantir une eau saine.' },
      { title: 'Tests', desc: 'Contrôle du bon fonctionnement du système thermodynamique.' },
      { title: 'Rapport', desc: 'Remise d\'un rapport détaillé avec l\'état de votre installation.' },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: 'Réservation', desc: 'Réservez votre nettoyage en ligne ou par téléphone.' },
      { title: 'Inspection préalable', desc: 'Vérification de l\'état des panneaux avant le nettoyage.' },
      { title: 'Nettoyage', desc: 'Les panneaux sont nettoyés avec de l\'eau pure et des brosses souples.' },
      { title: 'Rinçage', desc: 'Un rinçage final élimine tout résidu pour un résultat impeccable.' },
      { title: 'Vérification', desc: 'Comparaison de la production avant et après nettoyage.' },
      { title: 'Rapport', desc: 'Un rapport de service vous est envoyé après l\'intervention.' },
    ],
...
export const faqs: FAQ[] = [
  { q: 'À quelle fréquence faut-il entretenir ses installations énergétiques ?', a: 'La fréquence dépend du type d\'équipement. Pour une pompe à chaleur, un entretien annuel est recommandé. Pour les panneaux solaires, un contrôle et nettoyage tous les 1 à 2 ans est idéal. Le boiler thermodynamique nécessite un entretien annuel pour prévenir le calcaire et les risques sanitaires.' },
  { q: 'Quels sont les risques si je n\'entretiens pas mes équipements ?', a: 'Sans entretien régulier, vous risquez une baisse de performance (jusqu\'à 30 % de perte de rendement), une augmentation de votre consommation énergétique, des pannes coûteuses, et une réduction significative de la durée de vie de vos installations.' },
  { q: 'Quelle est la différence entre les contrats Zen Accès, Zen Équilibre et Zen Plus ?', a: 'Zen Accès propose un entretien tous les 2 ans. Zen Équilibre offre un entretien annuel. Zen Plus est notre formule premium avec un entretien annuel et les dépannages inclus (main-d\'œuvre et déplacement). Tous les contrats incluent un accès à votre espace client en ligne.' },
  { q: 'Intervenez-vous dans toute la Suisse romande ?', a: 'Oui, Zen Énergie Services intervient dans toute la Suisse romande. Notre siège est situé à Plan-les-Ouates (Genève) et nous disposons d\'un réseau de techniciens qualifiés couvrant l\'ensemble de la région.' },
  { q: 'Comment fonctionne le service PV Clean ?', a: 'PV Clean est un service de nettoyage ponctuel de vos panneaux solaires. À partir de CHF 392 pour 8 panneaux, nos équipes interviennent avec un système à eau pure et des brosses souples, sans produits chimiques. Aucun engagement — vous payez uniquement à l\'intervention.' },
]
