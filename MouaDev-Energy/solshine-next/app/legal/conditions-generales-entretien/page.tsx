        ...
        <main>
            ...
            <section style={{ background: '#fff', padding: '100px 20px' }}>
                <div style={{ maxWidth: 860, margin: '0 auto' }}>
                    <h2 style={{ fontFamily: "var(--font-barlow)", fontSize: 24, fontWeight: 600, color: '#000', marginBottom: 30 }}>CONDITIONS GÉNÉRALES D'ENTRETIEN (CGE)</h2>
